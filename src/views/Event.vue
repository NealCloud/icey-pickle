<template>
  ...
  <!-- <h1>Profile </h1>
  <p>{{eventData.first + ' ' + eventData.last}} </p>
  <p>{{eventData.email}}</p> -->
<div class="grid grid-cols-12">
  ...
  <div class="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
    ...
    <div class="px-6 py-4">
        <h1 class="text-xl font-semibold text-gray-800 dark:text-white">{{eventData.name}}</h1>
        ...
        <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 class="px-2 text-sm">{{eventData.location}}</h1>
        </div>
    </div>
</div>
  </div>
